...
{
	DrawSkill(blob, 1, "DodgeIcon.png", 0, 1, false, 0, 0);
	DrawSkill(blob, 2, "AmbushIcon.png", 1, 1, true, gap, 0);
	DrawSkill(blob, 3, "DoublestabIcon.png", 2, 1, true, gap*2, 0);
	DrawSkill(blob, 4, "ForesightIcon.png", 3, 1, true, gap*3, 0);
	DrawSkill(blob, 5, "RudeshockIcon.png", 4, 1, true, gap*4, 0);
	DrawSkill(blob, 6, "TendonundercutIcon.png", 5, 1, true, gap*5, 0);
	DrawSkill(blob, 7, "SpikeballsIcon.png", 6, 1, true, gap*6, 0);
	DrawSkill(blob, 8, "ThrowingknivesIcon.png", 7, 1, true, gap*7, 0);
	DrawSkill(blob, 9, "DeflectIcon.png", 8, 1, true, gap*8, 0);
	DrawSkill(blob, 10, "FlurryIcon.png", 9, 1, true, gap*9, 0);
}

void Draw2RowSkills(CBlob@ blob)
{
	const u8 gapy = 86;
	DrawSkill(blob, 11, "PrickinghitIcon.png", 0, 2, false, 0, gapy);
	DrawSkill(blob, 12, "PoisonedhitIcon.png", 1, 2, true, gap, gapy);
	DrawSkill(blob, 13, "BloodlustIcon.png", 2, 2, true, gap*2, gapy);
	DrawSkill(blob, 14, "ParalysisdartIcon.png", 3, 2, true, gap*3, gapy);
	DrawSkill(blob, 15, "PoisoncloudIcon.png", 4, 2, true, gap*4, gapy);
	DrawSkill(blob, 16, "IlluminationIcon.png", 5, 2, true, gap*5, gapy);
	DrawSkill(blob, 17, "InternalinstabilityIcon.png", 6, 2, true, gap*6, gapy);
	DrawSkill(blob, 18, "FlawIcon.png", 7, 2, true, gap*7, gapy);
	DrawSkill(blob, 19, "ShadowdaggersIcon.png", 8, 2, true, gap*8, gapy);
	DrawSkill(blob, 20, "ShadowessenceIcon.png", 9, 2, true, gap*9, gapy);
}
