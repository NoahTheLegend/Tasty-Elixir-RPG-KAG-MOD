...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
    ...
    if (!caller.get_bool("hashelmet"))
    {
	    ...
	    caller.CreateGenericButton("$demon_helmet$", Vec2f(0, 0), this, this.getCommandID("equip"), getTranslatedString("Equip"), params);
    }
    else
    {
        CBitStream params;
	    caller.CreateGenericButton("$demon_helmet$", Vec2f(0, 0), this, this.getCommandID("unequip"), getTranslatedString("Unequip helmet first!"), params);
    }
}
...
void onCommand(CBlob@ this, u8 cmd, CBitStream@ params)
{
    if (cmd==this.getCommandID("equip"))
    {
        ...
        if (caller !is null)
        {
	        ...
	        caller.set_string("helmetname", "demon_helmet");
