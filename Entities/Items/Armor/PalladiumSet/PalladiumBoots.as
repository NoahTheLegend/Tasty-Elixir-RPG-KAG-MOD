...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
    ...
    if (!caller.get_bool("hasboots"))
    {
	    ...
	    caller.CreateGenericButton("$palladium_boots$", Vec2f(0, 0), this, this.getCommandID("equip"), getTranslatedString("Equip"), params);
    }
    else
    {
        CBitStream params;
	    caller.CreateGenericButton("$palladium_boots$", Vec2f(0, 0), this, this.getCommandID("unequip"), getTranslatedString("Unequip boots first!"), params);
    }
}
...
void onCommand(CBlob@ this, u8 cmd, CBitStream@ params)
{
    if (cmd==this.getCommandID("equip"))
    {
        ...
        if (caller !is null)
        {
	        ...
	        caller.set_string("bootsname", "palladium_boots");
