...
const u16 heat_add = 8;
const u16 heat_add_constructed = 2;
const u16 heat_add_blob = 8;
const u16 heat_cool_amount = 1;

const u16 heat_cooldown_time = 9;
const u16 heat_cooldown_time_water = u16(heat_cooldown_time / 3);
					...
					if (map.getHitInfosFromArc((this.getPosition() - attackVel), -attackVel.Angle(), 30, distance, this, true, @hitInfos))
					{
						...
						for (uint i = 0; i < hitInfos.length; i++)
						{
							...
							else // map
							{
								...
								if (tiletypecustom > 392 && tiletypecustom < 432 || tiletypecustom > 447) 
								{
