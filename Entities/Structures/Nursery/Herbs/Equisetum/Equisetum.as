...
{
    this.set_u8("antisaturationthirst", XORRandom(5)+6);
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	caller.CreateGenericButton("$equisetum$", Vec2f(0, 0), this, this.getCommandID("use"), "Eat/use equisetum", params); 
}
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
    if (cmd == this.getCommandID("use"))
    {
        ...
        if (blob !is null)
        {
            if (blob.get_string("eff1") == "3_bleed")
            {
            ...
            else if (blob.get_string("eff2") == "3_bleed")
            {
            ...
            else if (blob.get_string("eff3") == "3_bleed")
            {
            ...
            else if (blob.get_string("eff4") == "3_bleed")
            {
            ...
            else if (blob.get_string("eff5") == "3_bleed")
            {
