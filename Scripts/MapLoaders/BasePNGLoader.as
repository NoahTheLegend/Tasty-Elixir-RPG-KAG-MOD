...
class PNGLoader
{
	...
	void handlePixel(const SColor &in pixel, int offset)
	{
		...
		else
		{
			...
			case map_colors::tile_iron:					map.SetTile(offset, CMap::tile_iron);
			{
			...
			case map_colors::tile_inferno_ash_back:     map.SetTile(offset, CMap::tile_inferno_ash_back);   break;
			case map_colors::tile_inferno_castle:		map.SetTile(offset, CMap::tile_inferno_castle);     break;
			case map_colors::tile_inferno_castle_back:	map.SetTile(offset, CMap::tile_inferno_castle_back);break;
...
void PlaceMostLikelyTile(CMap@ map, int offset)
{
	...
	if (up != CMap::tile_empty)
	{
		...
		else if ((neighborhood.find(CMap::tile_inferno_castle) != -1) ||
		         (neighborhood.find(CMap::tile_inferno_castle_back) != -1))
		{
			map.SetTile(offset, CMap::tile_inferno_castle_back);
		}
		else if ((neighborhood.find(CMap::tile_inferno_ash) != -1) ||
...
map_colors::tile_iron,             // | 112 |
map_colors::tile_iron,             // | 113 |
map_colors::unused,                // | 114 |
map_colors::unused,                // | 115 |
map_colors::tile_iron,             // | 116 | damaged
map_colors::tile_iron,             // | 117 | damaged
map_colors::tile_iron,             // | 118 | damaged
map_colors::tile_iron,             // | 119 | damaged
map_colors::tile_iron,             // | 120 | damaged
...
map_colors::tile_inferno_castle,   // | 128 |
map_colors::tile_inferno_castle,   // | 129 |
map_colors::tile_inferno_castle,   // | 130 |
map_colors::tile_inferno_castle,   // | 131 |
map_colors::tile_inferno_castle,   // | 132 |
map_colors::tile_inferno_castle,   // | 133 |
map_colors::tile_inferno_castle,   // | 134 |
map_colors::unused,                // | 135 |
map_colors::unused,                // | 136 |
map_colors::unused,                // | 137 |
map_colors::tile_inferno_castle,   // | 138 | damaged
map_colors::tile_inferno_castle,   // | 139 | damaged
map_colors::tile_inferno_castle,   // | 140 | damaged
map_colors::tile_inferno_castle,   // | 141 | damaged
map_colors::tile_inferno_castle,   // | 142 | damaged
map_colors::tile_inferno_castle,   // | 143 | damaged
map_colors::tile_inferno_castle_back,  // | 144 |
map_colors::tile_inferno_castle_back,  // | 145 |
map_colors::tile_inferno_castle_back,  // | 146 |
map_colors::tile_inferno_castle_back,  // | 147 |
map_colors::tile_inferno_castle_back,  // | 148 |
map_colors::tile_inferno_castle_back,  // | 149 |
...
map_colors::tile_inferno_castle_back,  // | 156 | damaged 
map_colors::tile_inferno_castle_back,  // | 157 | damaged
map_colors::tile_inferno_castle_back,  // | 158 | damaged
map_colors::tile_inferno_castle_back,  // | 159 | damaged
map_colors::tile_inferno_ash,      // | 160 |
map_colors::tile_inferno_ash,      // | 161 |
map_colors::tile_inferno_ash,      // | 162 |
map_colors::tile_inferno_ash,      // | 163 |
map_colors::tile_inferno_ash,      // | 164 |
map_colors::tile_inferno_ash,      // | 165 |
map_colors::tile_inferno_ash,      // | 166 |
...
map_colors::tile_inferno_ash,      // | 173 | damaged
map_colors::tile_inferno_ash,      // | 174 | damaged
map_colors::tile_inferno_ash,      // | 175 | damaged
map_colors::tile_inferno_ash_back, // | 176 |
map_colors::tile_inferno_ash_back, // | 177 |
map_colors::tile_inferno_ash_back, // | 178 |
map_colors::tile_inferno_ash_back, // | 179 |
map_colors::tile_inferno_ash_back, // | 180 |
map_colors::tile_inferno_ash_back, // | 181 |
map_colors::tile_inferno_ash_back, // | 182 |
map_colors::tile_inferno_ash_back, // | 183 |
map_colors::tile_inferno_ash_back, // | 184 |
map_colors::tile_inferno_ash_back, // | 185 |
